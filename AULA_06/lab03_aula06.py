...
# Adição da classe "cancelar_contrato" com 5 frases de treino
...
dados_imobiliaria = [
    ...
    # <<< ALTERAÇÃO LAB03: Nova intenção cancelar_contrato com 5 frases >>>
    # Intenção: cancelar_contrato
    ("Quero cancelar meu contrato de aluguel o mais rápido possível", "cancelar_contrato"),
    ("Como faço o distrato do meu contrato de locação?", "cancelar_contrato"),
    ("Preciso encerrar o contrato antes do prazo, qual o procedimento?", "cancelar_contrato"),
    ("Gostaria de solicitar o cancelamento do meu contrato imobiliário", "cancelar_contrato"),
    ("Quero rescindir o contrato e devolver as chaves do imóvel", "cancelar_contrato")
]
...
RESPOSTAS_PADRAO = {
    ...
    # <<< ALTERAÇÃO LAB03: Nova resposta padrão para cancelar_contrato >>>
    "cancelar_contrato": (
        "**Distrato e Cancelamento:** Recebemos sua solicitação de cancelamento. "
        "Para dar prosseguimento ao distrato, entre em contato com nosso setor jurídico pelo e-mail "
        "distrato@imobiliaria.com ou pelo telefone (11) 4002-8922. "
        "Um especialista irá orientá-lo sobre prazos, multas rescisórias e devolução de chaves."
    )
}
...
with gr.Blocks(theme=gr.themes.Soft(), title="SAC Imobiliário - LAB03 Nova Classe") as app:
    gr.Markdown(
        """
        #  SAC Imobiliário — ChatBot Inteligente (LAB03 - cancelar_contrato)
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            input_texto = gr.Textbox(
                lines=4,
                placeholder="Ex: Quero cancelar meu contrato de aluguel...",
            ...
            gr.Examples(
                examples=[
                    ...
                    ["Quero fazer o distrato do meu contrato de locação."],  # <<< Novo exemplo
